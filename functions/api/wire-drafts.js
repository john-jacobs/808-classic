  ...
  properties: {
    ...
    metadata: {
      ...
      properties: {
        ...
        scorecard: {
          type: "array",
          description: "Only include rows when the submitted material supports actual score data. Use an empty array for non-match dispatches, previews without scores, photo drops, logistics, rumors, rulings, or general updates. Never use scorecard as a list of people, invite statuses, captions, visits, allegations, or general notes.",
          items: {
            type: "object",
            additionalProperties: false,
